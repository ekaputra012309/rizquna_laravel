<div class="sidebar-menu">
    <ul class="menu">
        ...
        <li class="sidebar-item has-sub">
            ...
            <ul class="submenu">
                <li class="submenu-item">
                    <a href="{{ route('p.agent') }}" class="submenu-link"
                        >Agent</a
                    >
                </li>
                <li class="submenu-item">
                    <a href="{{ route('p.hotel') }}" class="submenu-link"
                        >Hotel</a
                    >
                </li>
                <li class="submenu-item">
                    <a href="{{ route('p.room') }}" class="submenu-link"
                        >Room</a
                    >
                </li>
                <li class="submenu-item">
                    <a href="{{ route('p.rekening') }}" class="submenu-link"
                        >Rekening</a
                    >
                </li>
            </ul>
        ...
        <li class="sidebar-item has-sub">
            ...
            <ul class="submenu">
                <li class="submenu-item">
                    <a href="{{ route('p.cabang') }}" class="submenu-link"
                        >Cabang</a
                    >
                </li>
                <li class="submenu-item">
                ...
                <li class="submenu-item">
                    <a href="{{ route('p.privilage') }}" class="submenu-link"
                        >Privilage</a
                    >
                </li>
                <li class="submenu-item">
                    <a
                        href="{{ route('p.user.management') }}"
                        class="submenu-link"
                        >User Management</a
                    >
                </li>
